...
@Component({
  selector: 'app-update-cliente-empresa',
  imports: [CustomInputComponent, CustomSelectComponent, ReactiveFormsModule, NgClass],
  templateUrl: './update-cliente-empresa.component.html',
  styles: ``,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class UpdateClienteEmpresaComponent {
  ...
  constructor(
    ...
    public readonly clienteService: ClientesService,
  ) {
  ...
  public submit(): void {
    ...
    of(this.loading.set(true))
      .pipe(
        mergeMap(() => this.clienteService.updateCustomer(updateByInfoPersona)),
